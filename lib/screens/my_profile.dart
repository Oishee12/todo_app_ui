...
import 'package:todoapp/screens/edit_profile.dart';
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: 10,),
                      Icon(Icons.alternate_email_rounded, color: Colors.green,),
                      Expanded(child: IgnorePointer(
                        child: CustomTextField(
                          hintText: "mojahid@gmail.com",
                          readOnly: true,
                          filled: true,
                          fillColor: Colors.white,
                          contentPadding: EdgeInsets.symmetric(vertical: 15, horizontal: 10),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(child: IgnorePointer(
                        child: CustomTextField(
                          hintText: "1234 Elm Street, Springfield, IL",
                          readOnly: true,
                          filled: true,
                          fillColor: Colors.white,
                          contentPadding: EdgeInsets.symmetric(vertical: 15, horizontal: 10),
